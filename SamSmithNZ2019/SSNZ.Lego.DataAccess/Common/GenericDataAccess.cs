...
namespace SSNZ.Lego.DataAccess.Common
{
    ...
    public class GenericDataAccess<T>
    {
        ...
        /// <summary>
        /// To create a new connection to the database. Uses the connection string in the calling applications appsettings.json file
        /// </summary>
