...
namespace SSNZ.Lego.Tests
{
    ...
    [TestClass]
    public class LegoPartsTests : TestBase
    {
        [TestCategory("IntegrationTest")]
        [TestMethod]
        public async Task GetLegoPartsTest()
        {
            //Arrange
            LegoPartsDA da = new LegoPartsDA();
            string setNum = "75218-1";

            //Act
            List<LegoParts> parts = await da.GetLegoPartsAsync(setNum);
