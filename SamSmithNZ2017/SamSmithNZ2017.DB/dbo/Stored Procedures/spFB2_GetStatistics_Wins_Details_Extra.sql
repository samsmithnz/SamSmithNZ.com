CREATE PROCEDURE [dbo].[spFB2_GetStatistics_Wins_Details_Extra]
AS

/*
SELECT convert(decimal(4,2),null) as spread,
	convert(smallint,null) as total_games_played,
	convert(smallint,null) as fav_home_games,
	...
	convert(smallint,null) as under_home_games,
