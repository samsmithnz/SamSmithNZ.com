CREATE PROCEDURE [dbo].spKS_FF_GetYearList
AS
...
UNION
SELECT year_code, CONVERT(varchar(5),year_code) + ': ' + CONVERT(varchar(50),song_count_total - song_count_with_date) + '/' + CONVERT(varchar(50),song_count_total) +  ' of shows have setlist data' as year_text
FROM #tmp_year
