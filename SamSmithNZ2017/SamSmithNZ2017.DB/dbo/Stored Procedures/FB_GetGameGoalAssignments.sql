...
BEGIN
	...
	CREATE TABLE #tmp_games_for_assigning (row_type INT, 
		...
		team_1_normal_time_score INT, team_1_extra_time_score INT, team_1_penalties_score INT, team_1_elo_rating INT,
		team_2_code INT, 
		team_2_name VARCHAR(200),
		team_2_normal_time_score INT, team_2_extra_time_score INT, team_2_penalties_score INT, team_2_elo_rating INT,
