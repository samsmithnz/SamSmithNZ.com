...
CREATE PROCEDURE [dbo].[spFB2_MoveToNextWeek]
	@year_code smallint
AS
...
exec spFB2_AddNewWeekTemplate @year_code, @new_week_code, @new_date
...
exec spFB2_UpdateStatus @year_code, @new_week_code, 25 --The Donut cost
