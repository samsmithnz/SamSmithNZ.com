...
FROM pm_project p
INNER JOIN pm_project_type pt ON p.project_type_code = pt.project_type_code
INNER JOIN pm_project_status ps ON p.project_status_code = ps.project_status_code
