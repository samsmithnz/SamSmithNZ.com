...
CREATE PROCEDURE [dbo].[spFB_MoveToNextWeek]
	@year_code smallint
AS
...
exec spFB_AddNewWeekTemplate @year_code, @new_week_code, @new_date
...
exec spFB_UpdateStatus @year_code, @new_week_code, 20
