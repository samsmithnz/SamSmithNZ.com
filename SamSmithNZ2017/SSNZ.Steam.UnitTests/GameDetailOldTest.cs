...
namespace SSNZ.Steam.UnitTests
{
    ...
    public class GameDetailOldTest
    {
        ...
        public void GameDetailsSamXCOMOldTest()
        {
            ...
            //Act
            GameDetail result = da.GetDataOld(steamId, appId);
        ...
        public void GameDetailsWithFriendSamXCOMFriendWithStewOldTest()
        {
            ...
            //Act
            GameDetail result = da.GetDataWithFriendOld(steamId, appId, friendSteamId);
        ...
        [TestMethod]
        public void GameDetailsApril24thFailOldTest()
        {
            //Arrange
            GameDetailsOldDA da = new GameDetailsOldDA();
