...
namespace SSNZ.IntFootball.UnitTests
{
    ...
    public class TournamentTests
    {
        ...
        private void TestSouthAfricaTournament(Tournament item)
        {
            ...
            Assert.IsTrue(item.R1TotalNumberOfTeamsThatAdvanceFromRound == 0);
            ...
            Assert.IsTrue(item.R2TotalNumberOfTeamsThatAdvanceFromRound == 0);
            ...
            Assert.IsTrue(item.R3TotalNumberOfTeamsThatAdvanceFromRound == 0);
