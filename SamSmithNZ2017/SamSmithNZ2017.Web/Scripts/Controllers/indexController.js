...
//    angular
//        .module('PartnerDBApp')
//        .controller('sessionSecurityController', sessionSecurityController);
//    sessionSecurityController.$inject = ['$scope', '$http', 'errorHandlerService', 'excelExportService', 'sessionYearService', 'securityFeatureService', 'utilityService', 'sessionSecurityAccessLevelService', 'sessionSecurityService', 'toaster', 'uiGridConstants', '$rootScope', '$filter', '$window', '$timeout', 'configSettings', '$templateCache', 'blockUI', 'validationService', 'commonDataService'];

//    function sessionSecurityController($scope, $http, errorHandlerService, excelExportService, sessionYearService, securityFeatureService, utilityService, sessionSecurityAccessLevelService, sessionSecurityService, toaster, uiGridConstants, $rootScope, $filter, $window, $timeout, configSettings, $templateCache, blockUI, validationService, commonDataService) {
