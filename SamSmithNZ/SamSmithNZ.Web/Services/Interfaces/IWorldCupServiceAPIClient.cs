...
namespace SamSmithNZ.Web.Services.Interfaces
{
    public interface IWorldCupServiceAPIClient
    {
        ...
        Task<List<TournamentImportStatus>> GetTournamentsImportStatus(int? competitionCode);
        ...
        Task<List<StatsAverageTournamentGoals>> GetStatsAverageTournamentGoalsList(int tournamentCode);
    }
}
