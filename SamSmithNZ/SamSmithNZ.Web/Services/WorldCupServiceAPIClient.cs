...
namespace SamSmithNZ.Web.Services
{
    public class WorldCupServiceAPIClient : BaseServiceAPIClient, IWorldCupServiceAPIClient
    {
        ...
        public async Task<List<Tournament>> GetTournaments(int? competitionCode)
        {
            string urlString = $"api/WorldCup/Tournament/GetTournaments";
        ...
        public async Task<List<StatsAverageTournamentGoals>> GetStatsAverageTournamentGoalsList()
        {
            Uri url = new($"api/WorldCup/StatsAverageTournamentGoals/GetStatsAverageTournamentGoalsList", UriKind.Relative);
